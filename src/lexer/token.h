...
enum class TokenType {
    ...
    //@class
    TOKEN_CLASS, TOKEN_ATTRIBUTES, TOKEN_METHODS, TOKEN_DCOLON, TOKEN_NEW, TOKEN_PUBLIC, TOKEN_PRIVATE, TOKEN_PROTECTED,TOKEN_REF, TOKEN_SUPER,
